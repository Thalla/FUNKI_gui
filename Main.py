...
tab1, tab2, tab3, tab4 = st.tabs(['Analysis', 'Results 1st dataset', 'Results 2nd dataset', 'Parameter Choice'])
...
with tab1:
    ...
    with paramcol1:
        ...
        w_omicstype   = st.selectbox('Omics Type', (UiVal.BULKRNA, UiVal.SCRNA, UiVal.PHOSPHO))
        w_inputformat = st.selectbox('Input data type', (UiVal.GENES, UiVal.MATRIX, UiVal.H5AD))
        # testdata
