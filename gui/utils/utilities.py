    ...
    st.markdown(
        ...
        <style>
            ...
            [data-testid="stSidebarNav"] {
                background-image: url('https://i.ibb.co/CP9qPhS/FUNKI.png');
...
def init_page():
    ...
    add_logo()
    show_pages([
        Page("Main.py","Main", ":linked_paperclips:"),
        Page("gui/pages/Help.py","Help", "🏠"),
    ...
    with col2:
        if isinstance(fig, str):
            ...
            if fig != 'false':
                ...
                st.write('There are two many significant transcriptions factors so that no plot is produced.')
        else:
            st.plotly_chart(fig)
